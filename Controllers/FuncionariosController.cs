...
namespace MoveisPlanejados.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public FuncionariosController(MoveisPlanejadosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("FuncionarioId,Nome,Matricula,Setor,Vencimento")] Funcionario funcionario)
        {
